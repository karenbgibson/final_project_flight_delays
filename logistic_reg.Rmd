...
mod1_0.5 <- newark_train %>%
  add_predictions(mod1, 
                  type = "response") %>% 
  mutate(pred_thresh_0.5 = pred >= threshold_mod1)
...
ggsave("images/proc_best_model.png",
       height = 7, width = 7)
```
...
conf_cancelled
```
Although AUC is 0.7, model is predicting more false positives than true negatives therefore model is not suitable. Data is too skewed to be suitable for logistic regression. 
